...
$color=0;
$result= $idconnect->query("SELECT phpbg_divisions.nom, phpbg_saisons.annee, (phpbg_saisons.annee)+1 
...
echo "<table class=\"tablephpbg2\" align=\"center\" cellspacing=\"0\"  width=\"100%\">";


$result= $idconnect->query("SELECT phpbg_journees.numero, cldom.nom, clext.nom, phpbg_matchs.buts_dom, phpbg_matchs.buts_ext, phpbg_matchs.date_reelle, phpbg_matchs.id
...
echo "<tr class=\"trphpbg3\"><td align=\"center\"><b>".JOURNEE."</b></td><td width=\"5%\"></td><td width=\"30%\" ><b>".DATE."</b></td><td colspan=\"5\"></td></tr>";
        while ($row=mysqli_fetch_array($result))
        {
