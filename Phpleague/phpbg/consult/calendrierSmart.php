...
$reponse=$idconnect->query("SELECT id_equipe_fetiche, phpbg_divisions.nom, phpbg_saisons.annee, (phpbg_saisons.annee)+1
...
$reponse= $idconnect->query("SELECT phpbg_clubs.nom, CLEXT.nom, phpbg_matchs.buts_dom, phpbg_matchs.buts_ext, phpbg_matchs.id, phpbg_matchs.date_reelle
...
$reponse= $idconnect->query("SELECT phpbg_journees.numero, phpbg_journees.date_prevue, cldom.nom, clext.nom, phpbg_matchs.buts_dom, phpbg_matchs.buts_ext, dom.id, ext.id
   ...
   $row[3] = stripslashes($row[3]);
        ...
        if (($journee=="0"))
            { 
              ...
              ?>
<br><table class="tablephpbg2" cellspacing="0" width="100%" align="center">
...
<table class="tablephpbg2" cellspacing="0" width="100%" align="center">
<tr class="trphpbg3"><td colspan="3" align="center"><b>
<?php echo ADMIN_COHERENCE_MSG2." ".$row[0].CONSULT_MATCHS_MSG2.$date."</b></td></tr>";
                $x=2;
            }
