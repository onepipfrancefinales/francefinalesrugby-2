...
$query="SELECT phpbg_clubs.nom, phpbg_equipes.id_club, phpbg_equipes.id_champ FROM phpbg_equipes, phpbg_clubs where phpbg_clubs.id=phpbg_equipes.id_club AND phpbg_equipes.id='$equipe'";
...
$query="SELECT phpbg_equipes.id FROM phpbg_equipes, phpbg_clubs WHERE id_champ='$champ' AND phpbg_equipes.id_club=phpbg_clubs.id AND phpbg_clubs.nom!='exempte'";
$result=mysql_query($query);
...
$query="SELECT id FROM phpbg_journees WHERE id_champ='$champ'";
$result=mysql_query($query);
$nb_journees=mysql_num_rows($result);

// On déterrmine l'année et le nom de la division
$query="SELECT phpbg_saisons.annee, phpbg_divisions.nom FROM phpbg_saisons, phpbg_divisions, phpbg_championnats where phpbg_championnats.id=$champ AND phpbg_divisions.id=phpbg_championnats.id_division and phpbg_championnats.id_saison=phpbg_saisons.id";
$result=mysql_query($query);
