...
$result= $idconnect->query("SELECT phpbg_clubs.id, phpbg_clubs.nom, id_champ, id_club
							FROM phpbg_clubs, phpbg_equipes
							WHERE phpbg_equipes.id_champ='$champ' and phpbg_equipes.id_club=phpbg_clubs.id
							ORDER BY nom");
...
$result= $idconnect->query("SELECT phpbg_classe.nom, phpbg_classe.id 
							FROM phpbg_classe 
							order by rang");
//$result=mysql_query ($query);
        ...
        echo "<tr class=\"trphpbg3\"><td align=\"center\"><b>$row[0]</b></td></tr>";
        $id_classe=$row[1];
        echo "<tr><td><table cellspacing=\"0\"><tr class=\"trphpbg\"><td>";
...
echo "<table class=\"tablephpbg2\" cellspacing=\"0\" align=\"center\" width=\"90%\"><tr class=\"trphpbg3\"><td align=\"center\"><b>Effectif</b></td></tr><tr><td>";

$result= $idconnect->query("SELECT phpbg_equipes.id 
							FROM phpbg_equipes, phpbg_clubs 
							WHERE phpbg_clubs.id='$id_clubs' 
							AND id_champ='$champ' 
...
{ $row[0]=addslashes($row[0]);
 $resultats1 = $idconnect->query("SELECT nom, prenom, phpbg_joueurs.id
									FROM phpbg_joueurs, phpbg_effectif
									WHERE phpbg_joueurs.id=phpbg_effectif.id_joueur
									AND phpbg_effectif.id_equipe='$equipe'
...
echo "<table class=\"tablephpbg2\" cellspacing=\"0\" align=\"center\" width=\"90%\"><tr class=\"trphpbg3\"><td align=\"center\"><b>".CONSULT_CLUB_4."</b></td></tr>";
        echo "<tr><td><center><img src=\"graph.php?equipe=$equipe\" alt=\"\"></center></td></tr>";


echo"</table><br /><br /><br />";

echo "<table class=\"tablephpbg2\" cellspacing=\"0\" align=\"center\" width=\"90%\"><tr class=\"trphpbg3\" align=\"center\"><td><b>".CONSULT_CLUB_3."</b></td></tr>";
...
$result= $idconnect->query("SELECT annee, phpbg_divisions.nom, phpbg_championnats.id, phpbg_equipes.id
							...
							AND phpbg_equipes.id_club='$id_clubs'
