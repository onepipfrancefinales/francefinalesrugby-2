...
if (isset($type))
{
   ...
   $row=mysqli_fetch_array($res);
    ...
    $res2=$idconnect->query("SELECT phpbg_equipes.id FROM phpbg_equipes, phpbg_clubs
...
if ($debut=="1" and $fin==$nb_journees)
{
   ...
   $res3=$idconnect->query("SELECT max(phpbg_journees.numero) FROM phpbg_journees, phpbg_matchs WHERE phpbg_journees.id=phpbg_matchs.id_journee and buts_dom is not NULL and     phpbg_journees.id_champ='$champ'");
