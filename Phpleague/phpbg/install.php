<link rel="stylesheet" type="text/css" href="../phpbg/league.css">
<body class=phpl>
...
$sql_maj_1="
  RENAME TABLE buteurs TO phpbg_buteurs,
  championnats TO phpbg_championnats,
  classe TO phpbg_classe,
  clmnt TO phpbg_clmnt,
  clmnt_graph TO phpbg_clmnt_graph,
  clmnt_pronos TO phpbg_clmnt_pronos,
  clubs TO phpbg_clubs,
  divisions TO phpbg_divisions,
  donnee TO phpbg_donnee,
  equipes TO phpbg_equipes,
  joueurs TO phpbg_joueurs,
  journees TO phpbg_journees,
  logo TO phpbg_logo,
  matchs TO phpbg_matchs,
  membres TO phpbg_membres,
  parametres TO phpbg_parametres,
  pronostics TO phpbg_pronostics,
  rens TO phpbg_rens,
  saisons TO phpbg_saisons,
  tapis_vert TO phpbg_tapis_vert;
  ALTER TABLE `phpbg_buteurs` CHANGE `id` `id` MEDIUMINT( 8 ) UNSIGNED NOT NULL AUTO_INCREMENT;
  ALTER TABLE `phpbg_championnats` CHANGE `id` `id` MEDIUMINT( 8 ) UNSIGNED NOT NULL AUTO_INCREMENT ";


$sql_maj_2="
  ALTER TABLE `phpbg_joueurs` CHANGE `photo` `photo` VARCHAR(250) NOT NULL,
  ...
  ALTER TABLE `phpbg_buteurs` CHANGE `id` `id` INT( 10 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_match` `id_match` INT( 10 ) UNSIGNED DEFAULT NULL ,
CHANGE `buts` `buts` TINYINT( 4 ) DEFAULT NULL;
ALTER TABLE `phpbg_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpbg_classe` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ,
CHANGE `rang` `rang` TINYINT( 3 ) DEFAULT '0' NOT NULL;
ALTER TABLE `phpbg_clmnt` CHANGE `NOM` `NOM` VARCHAR( 255 ) DEFAULT NULL ,
...
ALTER TABLE `phpbg_clmnt_graph` CHANGE `id_equipe` `id_equipe` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `fin` `fin` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `classement` `classement` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL;
ALTER TABLE `phpbg_clmnt_pronos` CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpbg_clmnt_graph` CHANGE `fin` `fin` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `classement` `classement` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL;
ALTER TABLE `phpbg_clubs` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL;
ALTER TABLE `phpbg_divisions` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ;
ALTER TABLE `phpbg_donnee` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpbg_equipes` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `id_club` `id_club` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `penalite` `penalite` TINYINT( 3 ) DEFAULT NULL;
ALTER TABLE `phpbg_gr_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ,
CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpbg_joueurs` CHANGE `nom` `nom` VARCHAR( 100 ) NOT NULL ,
CHANGE `prenom` `prenom` VARCHAR( 100 ) NOT NULL ,
...
ALTER TABLE `phpbg_journees` CHANGE `numero` `numero` TINYINT( 3 ) UNSIGNED NOT NULL ,
...
ALTER TABLE `phpbg_logo` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_club` `id_club` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `url` `url` TINYTEXT NOT NULL;
ALTER TABLE `phpbg_matchs` CHANGE `id` `id` MEDIUMINT( 6 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpbg_membres` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpbg_parametres` CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpbg_pronostics` CHANGE `id_membre` `id_membre` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpbg_rens` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 50 ) NOT NULL ,
CHANGE `id_classe` `id_classe` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `rang` `rang` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `url` `url` VARCHAR( 200 ) NOT NULL;
ALTER TABLE `phpbg_saisons` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `annee` `annee` YEAR( 4 ) DEFAULT '0000' NOT NULL;
ALTER TABLE `phpbg_buteurs` DROP `id_joueur`;
ALTER TABLE `phpbg_joueurs` DROP `id_club`;
DROP TABLE `phpbg_logo`";
  
$sql_maj_3 = "ALTER TABLE `phpbg_clmnt` ADD `ID_CHAMP` INT( 3 ) UNSIGNED NOT NULL ;
ALTER TABLE `phpbg_clubs` DROP INDEX `id`;
ALTER TABLE `phpbg_clubs` DROP INDEX `nom`;
ALTER TABLE `phpbg_championnats` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpbg_championnats` DROP INDEX `id`;
ALTER TABLE `phpbg_championnats` DROP INDEX `id_saison`;
ALTER TABLE `phpbg_championnats` DROP INDEX `id_division`;
ALTER TABLE `phpbg_classe` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpbg_classe` DROP INDEX `id`;
ALTER TABLE `phpbg_clmnt` ADD INDEX ( `ID_CHAMP` );
ALTER TABLE `phpbg_clmnt_graph` DROP INDEX `nom`;
ALTER TABLE `phpbg_clmnt_graph` ADD INDEX ( `id_equipe` );
ALTER TABLE `phpbg_clmnt_pronos` DROP INDEX `pseudo`;
ALTER TABLE `phpbg_clmnt_pronos` ADD INDEX ( `id_champ` );
ALTER TABLE `phpbg_divisions` DROP PRIMARY KEY;
ALTER TABLE `phpbg_divisions` DROP INDEX `nom_2`;
ALTER TABLE `phpbg_divisions` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpbg_divisions` DROP INDEX `id`;
ALTER TABLE `phpbg_equipes` DROP INDEX `id`;
ALTER TABLE `phpbg_journees` DROP INDEX `id`;
ALTER TABLE `phpbg_journees` DROP INDEX `numero`;
ALTER TABLE `phpbg_logo` DROP PRIMARY KEY;
ALTER TABLE `phpbg_logo` ADD PRIMARY KEY ( `id_club` );
ALTER TABLE `phpbg_logo` DROP INDEX `id_club`;
ALTER TABLE `phpbg_parametres` ADD PRIMARY KEY ( `id_champ` );
ALTER TABLE `phpbg_parametres` DROP INDEX `id_champ`;
ALTER TABLE `phpbg_pronostics` ADD INDEX ( `id_match` );
ALTER TABLE `phpbg_pronostics` DROP INDEX `id_champ`;
ALTER TABLE `phpbg_pronostics` ADD INDEX ( `id_membre` ); 
ALTER TABLE `phpbg_rens` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpbg_rens` DROP INDEX `id`;
ALTER TABLE `phpbg_saisons` DROP INDEX `id_2`;
ALTER TABLE `phpbg_saisons` DROP PRIMARY KEY;
ALTER TABLE `phpbg_saisons` ADD PRIMARY KEY ( `id` );
DROP TABLE `phpbg_tapis_vert`;
ALTER TABLE `phpbg_buteurs` ADD `id_effectif` SMALLINT( 5 ) UNSIGNED NOT NULL AFTER `id_match`;
ALTER TABLE `phpbg_clubs` ADD `url_logo` TINYTEXT NOT NULL";
...
$sql_gr_champ="CREATE TABLE phpbg_gr_championnats (
...
$sql_clmnt_cache="CREATE TABLE `phpbg_clmnt_cache` (
...
if ($res_clmnt_pronos = send_sql($sql_clmnt_pronos,SETUP_TABLE_3." clmnt_pronos"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpbg_clmnt_pronos ".SETUP_TABLE_2."</font>\n<br />";  }
		
if ($res_membres = send_sql($sql_membres,SETUP_TABLE_3." membres"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpbg_membres ".SETUP_TABLE_2."</font>\n<br />";}


if ($res_pronostics = send_sql($sql_pronostics,SETUP_TABLE_3." pronostics"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpbg_pronostics ".SETUP_TABLE_2."</font>\n<br />";}
...
if ($res_parametres = send_sql($sql_parametres,SETUP_TABLE_3." parametres"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpbg_parametres ".SETUP_TABLE_2."</font>\n<br />"; }
...
if ($res_gr_champ = send_sql($sql_gr_champ,SETUP_TABLE_3." groupe championnats"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpbg_gr_championnats ".SETUP_TABLE_2."</font>\n<br />"; }

if ($res_gr_champ = send_sql($sql_clmnt_cache,SETUP_TABLE_3." classement cache"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpbg_clmnt_cache ".SETUP_TABLE_2."</font>\n<br />"; }


$requete="SELECT id_club, url FROM phpbg_logo";
...
while($row = mysql_fetch_array($resultat))
{
  $url_logo=$row["url"];
  $id_club=$row["id_club"];
  $requete2="UPDATE phpbg_clubs SET url_logo = '$url_logo'  WHERE id = '$id_club'";
  $resultat2=mysql_query($requete2) or die (mysql_error());

}

$requete="SELECT DISTINCT phpbg_joueurs.id, phpbg_equipes.id
          FROM phpbg_joueurs, phpbg_equipes, phpbg_buteurs, phpbg_matchs, phpbg_clubs
          WHERE phpbg_equipes.id_club=phpbg_clubs.id
          AND (
           phpbg_matchs.id_equipe_dom = phpbg_equipes.id
           OR phpbg_matchs.id_equipe_ext = phpbg_equipes.id
              )
          AND phpbg_matchs.id=phpbg_buteurs.id_match
          AND phpbg_joueurs.id_club=phpbg_equipes.id_club
          AND phpbg_buteurs.id_joueur=phpbg_joueurs.id";

$resultat=mysql_query($requete) or die (mysql_error());

while($row = mysql_fetch_array($resultat))
{
 mysql_query ("INSERT INTO phpbg_effectif (id_joueur, id_equipe) values ('$row[0]','$row[1]')") or die ("probleme " .mysql_error());
}

$requete="SELECT phpbg_effectif.id, phpbg_buteurs.id_match, phpbg_joueurs.id
          FROM phpbg_joueurs, phpbg_equipes, phpbg_buteurs, phpbg_matchs, phpbg_clubs, phpbg_effectif
          WHERE phpbg_equipes.id_club=phpbg_clubs.id
          AND (
           phpbg_matchs.id_equipe_dom = phpbg_equipes.id
           OR phpbg_matchs.id_equipe_ext = phpbg_equipes.id
          ...
          AND phpbg_joueurs.id_club=phpbg_equipes.id_club
          AND phpbg_buteurs.id_joueur=phpbg_joueurs.id
          AND phpbg_effectif.id_joueur=phpbg_joueurs.id
          AND phpbg_effectif.id_equipe=phpbg_equipes.id";
          
$resultat=mysql_query($requete) or die (mysql_error());

while($row = mysql_fetch_array($resultat))
{
 mysql_query ("UPDATE phpbg_buteurs SET id_effectif='$row[0]' WHERE id_match='$row[1]' and id_joueur='$row[2]'") or die ("probleme " .mysql_error());
}


$requete="SELECT DISTINCT phpbg_joueurs.nom, phpbg_joueurs.prenom, phpbg_buteurs.id, phpbg_journees.numero, phpbg_matchs.date_reelle, phpbg_joueurs.id
FROM phpbg_joueurs, phpbg_buteurs, phpbg_matchs, phpbg_equipes, phpbg_journees
WHERE phpbg_matchs.id = phpbg_buteurs.id_match
AND phpbg_buteurs.id_joueur = phpbg_joueurs.id
AND phpbg_buteurs.id_effectif =0
AND (
phpbg_matchs.id_equipe_dom = phpbg_equipes.id
OR phpbg_matchs.id_equipe_ext = phpbg_equipes.id
    )
AND phpbg_journees.id = phpbg_matchs.id_journee";
          
$resultat=mysql_query($requete) or die (mysql_error());

if (!mysql_num_rows( $resultat )=='0')
{
echo "<form method=\"post\" action=../phpbg//%22/%22>";
$i=0;
while($row = mysql_fetch_array($resultat))
{  
  echo SETUP_MAJ_INCOH." : $row[0] $row[1] ".SETUP_MAJ_INCOH_2." : ";
  $requete1="SELECT phpbg_clubs.nom, phpbg_equipes.id, phpbg_matchs.id
             FROM phpbg_joueurs, phpbg_equipes, phpbg_buteurs, phpbg_matchs, phpbg_clubs, phpbg_journees
             WHERE phpbg_equipes.id_club = phpbg_clubs.id
             AND (
             phpbg_matchs.id_equipe_dom = phpbg_equipes.id
             OR phpbg_matchs.id_equipe_ext = phpbg_equipes.id
...
$sql_maj_1="ALTER TABLE `phpbg_buteurs` CHANGE `id` `id` INT( 10 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_match` `id_match` INT( 10 ) UNSIGNED DEFAULT NULL ,
CHANGE `buts` `buts` TINYINT( 4 ) DEFAULT NULL;
ALTER TABLE `phpbg_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_division` `id_division` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
$sql_maj_2="ALTER TABLE `phpbg_clubs` DROP INDEX `id`;
ALTER TABLE `phpbg_clubs` DROP INDEX `nom`;
ALTER TABLE `phpbg_championnats` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpbg_championnats` DROP INDEX `id`;
ALTER TABLE `phpbg_championnats` DROP INDEX `id_saison`;
...
$requete="SELECT id_equipe, pts FROM phpbg_tapis_vert";
$resultat=mysql_query($requete) or die (mysql_error());
...
while($row = mysql_fetch_array($resultat))
{
  ...
  $requete2="UPDATE phpbg_equipes SET penalite = '$pts'  WHERE id = '$id_equipe'";
  $resultat2=mysql_query($requete2) or die (mysql_error());
}
...
CREATE TABLE `phpbg_clmnt_cache` (
  `NOM` varchar(255) default NULL,
  `POINTS` smallint(4) unsigned default NULL,
  `JOUES` tinyint(3) unsigned default NULL,
  `G` tinyint(3) unsigned default NULL,
...
CREATE TABLE `phpbg_divisions` (
  `id` int(4) unsigned NOT NULL auto_increment,
  `nom` varchar(255) NOT NULL default '',
  PRIMARY KEY  (`id`)
) ;
CREATE TABLE `phpbg_donnee` (
  `id` smallint(5) unsigned NOT NULL auto_increment,
  `nom` text NOT NULL,
...
CREATE TABLE `phpbg_gr_championnats` (
  `id` tinyint(3) unsigned NOT NULL auto_increment,
  `nom` varchar(255) NOT NULL default '',
...
CREATE TABLE `phpbg_saisons` (
  `id` int(4) unsigned NOT NULL auto_increment,
  `annee` year(4) NOT NULL default '0000',
  PRIMARY KEY  (`id`),
  KEY `id` (`id`)
) ;
INSERT INTO `phpbg_membres` (`id_prono` , `pseudo` , `mot_de_passe` , `mail` , `nom_site` , `url_site`, `admin` )
                    VALUES ('$id_prono', '$pseudo', '$mdp', '$mail', '$nom_site', '$url_site','1')";
...
{ 
$to="phpbgeague@univert.org<phpleague@univert.org>";

$sujet="Nouvel utilisateur";

$message="<html><head>
<title>phpbgeague</title>
</head>
<body>
<p align=\"center\"><u><font face=\"Verdana\" size=\"3\" color=\"#006A36\">Nouvel
utilisateur</font></u></p>
<p><font size=\"2\" face=\"Verdana\">Url : <a href=../phpbg//%22$url_site/%22>$url_site</a></font></p>
