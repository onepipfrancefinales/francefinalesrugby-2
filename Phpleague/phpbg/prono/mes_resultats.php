...
$result=$idconnect->query("
		...
		FROM phpbg_clmnt_pronos, phpbg_membres, phpbg_gr_championnats
		WHERE type='general' 
		AND phpbg_membres.id=phpbg_clmnt_pronos.id_membre 
		AND phpbg_gr_championnats.id='$gr_champ' 
		AND phpbg_clmnt_pronos.id_champ='$gr_champ' 
		AND phpbg_membres.id_prono='$user_id'
		GROUP BY participation
		ORDER by points 
		DESC, participation 
		DESC, phpbg_membres.pseudo");
...
FROM phpbg_clmnt_pronos, phpbg_membres, phpbg_gr_championnats
WHERE type='mensuel_en_cours' AND phpbg_membres.id=phpbg_clmnt_pronos.id_membre and phpbg_gr_championnats.id='$gr_champ' and phpbg_clmnt_pronos.id_champ='$gr_champ' and phpbg_membres.id_prono='$user_id'
...
$result=$idconnect->query("SELECT points, participation, id_prono, pts_prono_participation,pts_prono_exact
FROM phpbg_clmnt_pronos, phpbg_membres, phpbg_gr_championnats
WHERE type='mensuel_30_jours' AND phpbg_membres.id=phpbg_clmnt_pronos.id_membre and phpbg_gr_championnats.id='$gr_champ' and phpbg_membres.id_prono='$user_id'
ORDER by points desc, participation desc, phpbg_membres.pseudo");
//$result=mysql_query($query) or die ("probleme " .mysql_error());
...
$result=$idconnect->query("SELECT points, participation, id_prono, pts_prono_participation,pts_prono_exact
FROM phpbg_clmnt_pronos, phpbg_membres, phpbg_gr_championnats
WHERE type='hebdo' AND phpbg_membres.id=phpbg_clmnt_pronos.id_membre and phpbg_gr_championnats.id='$gr_champ' and phpbg_membres.id_prono='$user_id'
ORDER by points desc, participation desc, phpbg_membres.pseudo");
//$result=mysql_query($query) or die ("probleme " .mysql_error());
