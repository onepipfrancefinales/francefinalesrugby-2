...
<table class=phpbg width="80%">
  <tr>
    <td class=phpbg2 align="center" colspan="3">
  ...
  <tr>
    <td align="center">
	  <?php
		...
		mysqli_query($idconnect,("DELETE FROM phpbg_clmnt_pronos 
		...
		$result=$idconnect->query(" 
				...
				FROM phpbg_membres, phpbg_pronostics
				WHERE id_champ='$gr_champ' 
		...
		$result=$idconnect->query("
				...
				FROM phpbg_membres, phpbg_pronostics, phpbg_matchs
				WHERE id_champ='$gr_champ'
				AND id_membre=phpbg_membres.id
