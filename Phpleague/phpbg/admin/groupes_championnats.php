...
{   
  mysqli_query ($idconnect,("INSERT INTO phpbg_gr_championnats (nom) VALUES ('$nom_group')")) or die ("probleme " .mysql_error($idconnect));
}


if ($confirm=="ok" and $gr_champ and $action=="supp")
{
      mysqli_query($idconnect,("DELETE FROM phpbg_gr_championnats WHERE id ='$gr_champ' "))or die ("probleme " .mysql_error($idconnect));
}
?>

<br /><font class=phpbg><?php echo GR_LEAGUE; ?></font><br /><br />

<table class=phpbg width="90%">
            <tr>
              <td class=phpbg2><?php echo MENU_ID; ?></td>
              <td class=phpbg2><?php echo MENU_NOM; ?></td>
              <td class=phpbg2></td>
            </tr>
