...
$color=0;
$result= $idconnect->query("SELECT phpfed2_divisions.nom, phpfed2_saisons.annee, (phpfed2_saisons.annee)+1 
...
echo "<table class=\"tablephpfed22\" align=\"center\" cellspacing=\"0\"  width=\"100%\">";


$result= $idconnect->query("SELECT phpfed2_journees.numero, cldom.nom, clext.nom, phpfed2_matchs.buts_dom, phpfed2_matchs.buts_ext, phpfed2_matchs.date_reelle, phpfed2_matchs.id
...
echo "<tr class=\"trphpfed23\"><td align=\"center\"><b>".JOURNEE."</b></td><td width=\"5%\"></td><td width=\"30%\" ><b>".DATE."</b></td><td colspan=\"5\"></td></tr>";
        while ($row=mysqli_fetch_array($result))
        {
