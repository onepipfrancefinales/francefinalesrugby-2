...
?>
    ...
    $id_equipe_fetiche=$row['id_equipe_fetiche'];
     ...
     $resultats=$idconnect->query("SELECT phpfed2_equipes.id FROM phpfed2_equipes, phpfed2_clubs
   ...
   $requete=$idconnect->query("SELECT DISTINCT * FROM phpfed2_clmnt_cache WHERE ID_CHAMP='$champ' ORDER BY POINTS DESC, PEN DESC, DIFF DESC, BUTSPOUR DESC , BUTSCONTRE ASC, NOM");
