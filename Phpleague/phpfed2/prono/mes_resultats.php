...
$result=$idconnect->query("
		...
		FROM phpfed2_clmnt_pronos, phpfed2_membres, phpfed2_gr_championnats
		WHERE type='general' 
		AND phpfed2_membres.id=phpfed2_clmnt_pronos.id_membre 
		AND phpfed2_gr_championnats.id='$gr_champ' 
		AND phpfed2_clmnt_pronos.id_champ='$gr_champ' 
		AND phpfed2_membres.id_prono='$user_id'
		GROUP BY participation
		ORDER by points 
		DESC, participation 
		DESC, phpfed2_membres.pseudo");
...
FROM phpfed2_clmnt_pronos, phpfed2_membres, phpfed2_gr_championnats
WHERE type='mensuel_en_cours' AND phpfed2_membres.id=phpfed2_clmnt_pronos.id_membre and phpfed2_gr_championnats.id='$gr_champ' and phpfed2_clmnt_pronos.id_champ='$gr_champ' and phpfed2_membres.id_prono='$user_id'
...
$result=$idconnect->query("SELECT points, participation, id_prono, pts_prono_participation,pts_prono_exact
FROM phpfed2_clmnt_pronos, phpfed2_membres, phpfed2_gr_championnats
WHERE type='mensuel_30_jours' AND phpfed2_membres.id=phpfed2_clmnt_pronos.id_membre and phpfed2_gr_championnats.id='$gr_champ' and phpfed2_membres.id_prono='$user_id'
ORDER by points desc, participation desc, phpfed2_membres.pseudo");
//$result=mysql_query($query) or die ("probleme " .mysql_error());
...
$result=$idconnect->query("SELECT points, participation, id_prono, pts_prono_participation,pts_prono_exact
FROM phpfed2_clmnt_pronos, phpfed2_membres, phpfed2_gr_championnats
WHERE type='hebdo' AND phpfed2_membres.id=phpfed2_clmnt_pronos.id_membre and phpfed2_gr_championnats.id='$gr_champ' and phpfed2_membres.id_prono='$user_id'
ORDER by points desc, participation desc, phpfed2_membres.pseudo");
//$result=mysql_query($query) or die ("probleme " .mysql_error());
