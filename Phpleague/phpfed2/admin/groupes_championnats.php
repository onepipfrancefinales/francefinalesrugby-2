...
{   
  mysqli_query ($idconnect,("INSERT INTO phpfed2_gr_championnats (nom) VALUES ('$nom_group')")) or die ("probleme " .mysql_error($idconnect));
}


if ($confirm=="ok" and $gr_champ and $action=="supp")
{
      mysqli_query($idconnect,("DELETE FROM phpfed2_gr_championnats WHERE id ='$gr_champ' "))or die ("probleme " .mysql_error($idconnect));
}
?>

<br /><font class=phpfed2><?php echo GR_LEAGUE; ?></font><br /><br />

<table class=phpfed2 width="90%">
            <tr>
              <td class=phpfed22><?php echo MENU_ID; ?></td>
              <td class=phpfed22><?php echo MENU_NOM; ?></td>
              <td class=phpfed22></td>
            </tr>
