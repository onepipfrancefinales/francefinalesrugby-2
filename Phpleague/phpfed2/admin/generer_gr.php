...
<table class=phpfed2 width="80%">
  <tr>
    <td class=phpfed22 align="center" colspan="3">
  ...
  <tr>
    <td align="center">
	  <?php
		...
		mysqli_query($idconnect,("DELETE FROM phpfed2_clmnt_pronos 
		...
		$result=$idconnect->query(" 
				...
				FROM phpfed2_membres, phpfed2_pronostics
				WHERE id_champ='$gr_champ' 
		...
		$result=$idconnect->query("
				...
				FROM phpfed2_membres, phpfed2_pronostics, phpfed2_matchs
				WHERE id_champ='$gr_champ'
				AND id_membre=phpfed2_membres.id
