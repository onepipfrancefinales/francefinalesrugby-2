  ...
  if ($nb_resultats>0)
     { 
      //Màj des paramètres
	   ...
	   UPDATE phpfed2_gr_championnats 
   ...
   else
     {
	  ...
	  mysqli_query($idconnect,("
	  INSERT INTO phpfed2_gr_championnats (id_champ, pts_prono_exact, pts_prono_participation, id_master, tps_avant_prono) 
...
echo "nom : ".$nom_gr_champ;
    mysqli_query($idconnect,("DELETE FROM phpfed2_gr_championnats 
							  WHERE id = '$gr_champ'"));

     reset ($champ);
	 while ( list($cle, $val)= each($champ))
         {
		  mysqli_query($idconnect,("INSERT INTO phpfed2_gr_championnats (id, nom, id_champ, activ_prono, pts_prono_exact, pts_prono_participation, id_master,tps_avant_prono)
...
<table class=phpfed2 width="80%">
            ...
            <tr>
              <td align="center" class=phpfed26 colspan="4"><b><?php echo ADMIN_GR_CHAMP_EDIT_5; ?></b></td>
            </tr>
              <td class=phpfed23 colspan="5" align="center"><?php  champ_gr_menu ($gr_champ, $idconnect);echo "test3"; ?></td>
...
<table class=phpfed2 width="80%">
            <tr>
              <td class=phpfed22 align="center" colspan="3"><?php echo ADMIN_PARAM_MSG13." "; affich_gr_champ ($gr_champ, $idconnect);echo "test4"; ?></td>
            </tr>
            <tr>
