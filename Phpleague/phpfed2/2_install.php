<link rel="stylesheet" type="text/css" href="../phpfed2/league.css">
<body class=phpfed2>
 <table class=tablephpfed22 border="0" cellspacing="0" width="100%">
    <tr class=trphpfed23>
      <td width="100%">
...
$requete="SELECT id FROM phpfed2_effectif WHERE id_joueur='$id_joueur' AND id_equipe='$id_equipes'";
$resultats=mysql_query($requete);
//if (!$result) die mysql_error();
$nb=mysql_num_rows( $resultats );

     if ($nb=="0") { mysql_query ("INSERT INTO phpfed2_effectif (id_joueur, id_equipe) VALUES ('$id_joueur', '$id_equipes')");}

          $requete="SELECT DISTINCT phpfed2_effectif.id
FROM phpfed2_joueurs, phpfed2_buteurs, phpfed2_matchs, phpfed2_equipes, phpfed2_effectif
WHERE phpfed2_matchs.id = phpfed2_buteurs.id_match
AND (
phpfed2_matchs.id_equipe_dom = phpfed2_equipes.id
OR phpfed2_matchs.id_equipe_ext = phpfed2_equipes.id
)
AND phpfed2_matchs.id = '$id_match'
AND phpfed2_equipes.id ='$id_equipes'
AND phpfed2_joueurs.id ='$id_joueur'
AND phpfed2_joueurs.id = phpfed2_effectif.id_joueur
AND phpfed2_effectif.id_equipe=phpfed2_equipes.id";

    
          $resultats = mysql_query ($requete) or die (mysql_error());
          while ($row=mysql_fetch_array($resultats))
          {
           mysql_query ("UPDATE phpfed2_buteurs SET phpfed2_buteurs.id_effectif='$row[0]' WHERE id_match='$id_match' and id_effectif='0'");
          }
...
$sql_maj_1="
  RENAME TABLE buteurs TO phpfed2_buteurs,
  championnats TO phpfed2_championnats,
  classe TO phpfed2_classe,
  clmnt TO phpfed2_clmnt,
  clmnt_graph TO phpfed2_clmnt_graph,
  clmnt_pronos TO phpfed2_clmnt_pronos,
  clubs TO phpfed2_clubs,
  divisions TO phpfed2_divisions,
  donnee TO phpfed2_donnee,
  equipes TO phpfed2_equipes,
  joueurs TO phpfed2_joueurs,
  journees TO phpfed2_journees,
  logo TO phpfed2_logo,
  matchs TO phpfed2_matchs,
  membres TO phpfed2_membres,
  parametres TO phpfed2_parametres,
  pronostics TO phpfed2_pronostics,
  rens TO phpfed2_rens,
  saisons TO phpfed2_saisons,
  tapis_vert TO phpfed2_tapis_vert;
  ALTER TABLE `phpfed2_buteurs` CHANGE `id` `id` MEDIUMINT( 8 ) UNSIGNED NOT NULL AUTO_INCREMENT;
  ALTER TABLE `phpfed2_championnats` CHANGE `id` `id` MEDIUMINT( 8 ) UNSIGNED NOT NULL AUTO_INCREMENT ";


$sql_maj_2="
  ALTER TABLE `phpfed2_joueurs` CHANGE `photo` `photo` VARCHAR(250) NOT NULL,
  ...
  ALTER TABLE `phpfed2_buteurs` CHANGE `id` `id` INT( 10 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_match` `id_match` INT( 10 ) UNSIGNED DEFAULT NULL ,
CHANGE `buts` `buts` TINYINT( 4 ) DEFAULT NULL;
ALTER TABLE `phpfed2_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpfed2_classe` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ,
CHANGE `rang` `rang` TINYINT( 3 ) DEFAULT '0' NOT NULL;
ALTER TABLE `phpfed2_clmnt` CHANGE `NOM` `NOM` VARCHAR( 255 ) DEFAULT NULL ,
...
ALTER TABLE `phpfed2_clmnt_graph` CHANGE `id_equipe` `id_equipe` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `fin` `fin` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `classement` `classement` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL;
ALTER TABLE `phpfed2_clmnt_pronos` CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpfed2_clmnt_graph` CHANGE `fin` `fin` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `classement` `classement` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL;
ALTER TABLE `phpfed2_clubs` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL;
ALTER TABLE `phpfed2_divisions` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ;
ALTER TABLE `phpfed2_donnee` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpfed2_equipes` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `id_club` `id_club` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `penalite` `penalite` TINYINT( 3 ) DEFAULT NULL;
ALTER TABLE `phpfed2_gr_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 255 ) NOT NULL ,
CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpfed2_joueurs` CHANGE `nom` `nom` VARCHAR( 100 ) NOT NULL ,
CHANGE `prenom` `prenom` VARCHAR( 100 ) NOT NULL ,
...
ALTER TABLE `phpfed2_journees` CHANGE `numero` `numero` TINYINT( 3 ) UNSIGNED NOT NULL ,
...
ALTER TABLE `phpfed2_logo` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_club` `id_club` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `url` `url` TINYTEXT NOT NULL;
ALTER TABLE `phpfed2_matchs` CHANGE `id` `id` MEDIUMINT( 6 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpfed2_membres` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `phpfed2_parametres` CHANGE `id_champ` `id_champ` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpfed2_pronostics` CHANGE `id_membre` `id_membre` SMALLINT( 5 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
ALTER TABLE `phpfed2_rens` CHANGE `id` `id` SMALLINT( 5 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `nom` `nom` VARCHAR( 50 ) NOT NULL ,
CHANGE `id_classe` `id_classe` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `rang` `rang` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
CHANGE `url` `url` VARCHAR( 200 ) NOT NULL;
ALTER TABLE `phpfed2_saisons` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `annee` `annee` YEAR( 4 ) DEFAULT '0000' NOT NULL;
ALTER TABLE `phpfed2_buteurs` DROP `id_joueur`;
ALTER TABLE `phpfed2_joueurs` DROP `id_club`;
DROP TABLE `phpfed2_logo`";
  
$sql_maj_3 = "ALTER TABLE `phpfed2_clmnt` ADD `ID_CHAMP` INT( 3 ) UNSIGNED NOT NULL ;
ALTER TABLE `phpfed2_clubs` DROP INDEX `id`;
ALTER TABLE `phpfed2_clubs` DROP INDEX `nom`;
ALTER TABLE `phpfed2_championnats` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpfed2_championnats` DROP INDEX `id`;
ALTER TABLE `phpfed2_championnats` DROP INDEX `id_saison`;
ALTER TABLE `phpfed2_championnats` DROP INDEX `id_division`;
ALTER TABLE `phpfed2_classe` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpfed2_classe` DROP INDEX `id`;
ALTER TABLE `phpfed2_clmnt` ADD INDEX ( `ID_CHAMP` );
ALTER TABLE `phpfed2_clmnt_graph` DROP INDEX `nom`;
ALTER TABLE `phpfed2_clmnt_graph` ADD INDEX ( `id_equipe` );
ALTER TABLE `phpfed2_clmnt_pronos` DROP INDEX `pseudo`;
ALTER TABLE `phpfed2_clmnt_pronos` ADD INDEX ( `id_champ` );
ALTER TABLE `phpfed2_divisions` DROP PRIMARY KEY;
ALTER TABLE `phpfed2_divisions` DROP INDEX `nom_2`;
ALTER TABLE `phpfed2_divisions` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpfed2_divisions` DROP INDEX `id`;
ALTER TABLE `phpfed2_equipes` DROP INDEX `id`;
ALTER TABLE `phpfed2_journees` DROP INDEX `id`;
ALTER TABLE `phpfed2_journees` DROP INDEX `numero`;
ALTER TABLE `phpfed2_logo` DROP PRIMARY KEY;
ALTER TABLE `phpfed2_logo` ADD PRIMARY KEY ( `id_club` );
ALTER TABLE `phpfed2_logo` DROP INDEX `id_club`;
ALTER TABLE `phpfed2_parametres` ADD PRIMARY KEY ( `id_champ` );
ALTER TABLE `phpfed2_parametres` DROP INDEX `id_champ`;
ALTER TABLE `phpfed2_pronostics` ADD INDEX ( `id_match` );
ALTER TABLE `phpfed2_pronostics` DROP INDEX `id_champ`;
ALTER TABLE `phpfed2_pronostics` ADD INDEX ( `id_membre` ); 
ALTER TABLE `phpfed2_rens` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpfed2_rens` DROP INDEX `id`;
ALTER TABLE `phpfed2_saisons` DROP INDEX `id_2`;
ALTER TABLE `phpfed2_saisons` DROP PRIMARY KEY;
ALTER TABLE `phpfed2_saisons` ADD PRIMARY KEY ( `id` );
DROP TABLE `phpfed2_tapis_vert`;
ALTER TABLE `phpfed2_buteurs` ADD `id_effectif` SMALLINT( 5 ) UNSIGNED NOT NULL AFTER `id_match`;
ALTER TABLE `phpfed2_clubs` ADD `url_logo` TINYTEXT NOT NULL";
...
$sql_gr_champ="CREATE TABLE phpfed2_gr_championnats (
...
$sql_clmnt_cache="CREATE TABLE `phpfed2_clmnt_cache` (
...
if ($res_clmnt_pronos = send_sql($sql_clmnt_pronos,SETUP_TABLE_3." clmnt_pronos"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpfed2_clmnt_pronos ".SETUP_TABLE_2."</font>\n<br />";  }
		
if ($res_membres = send_sql($sql_membres,SETUP_TABLE_3." membres"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpfed2_membres ".SETUP_TABLE_2."</font>\n<br />";}


if ($res_pronostics = send_sql($sql_pronostics,SETUP_TABLE_3." pronostics"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpfed2_pronostics ".SETUP_TABLE_2."</font>\n<br />";}
...
if ($res_parametres = send_sql($sql_parametres,SETUP_TABLE_3." parametres"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpfed2_parametres ".SETUP_TABLE_2."</font>\n<br />"; }
...
if ($res_gr_champ = send_sql($sql_gr_champ,SETUP_TABLE_3." groupe championnats"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpfed2_gr_championnats ".SETUP_TABLE_2."</font>\n<br />"; }

if ($res_gr_champ = send_sql($sql_clmnt_cache,SETUP_TABLE_3." classement cache"))
   { echo "<font color=\"#009900\" size=\"2\" face=\"Verdana\">".SETUP_TABLE." phpfed2_clmnt_cache ".SETUP_TABLE_2."</font>\n<br />"; }


$requete="SELECT id_club, url FROM phpfed2_logo";
...
while($row = mysql_fetch_array($resultat))
{
  $url_logo=$row["url"];
  $id_club=$row["id_club"];
  $requete2="UPDATE phpfed2_clubs SET url_logo = '$url_logo'  WHERE id = '$id_club'";
  $resultat2=mysql_query($requete2) or die (mysql_error());

}

$requete="SELECT DISTINCT phpfed2_joueurs.id, phpfed2_equipes.id
          FROM phpfed2_joueurs, phpfed2_equipes, phpfed2_buteurs, phpfed2_matchs, phpfed2_clubs
          WHERE phpfed2_equipes.id_club=phpfed2_clubs.id
          AND (
           phpfed2_matchs.id_equipe_dom = phpfed2_equipes.id
           OR phpfed2_matchs.id_equipe_ext = phpfed2_equipes.id
              )
          AND phpfed2_matchs.id=phpfed2_buteurs.id_match
          AND phpfed2_joueurs.id_club=phpfed2_equipes.id_club
          AND phpfed2_buteurs.id_joueur=phpfed2_joueurs.id";

$resultat=mysql_query($requete) or die (mysql_error());

while($row = mysql_fetch_array($resultat))
{
 mysql_query ("INSERT INTO phpfed2_effectif (id_joueur, id_equipe) values ('$row[0]','$row[1]')") or die ("probleme " .mysql_error());
}

$requete="SELECT phpfed2_effectif.id, phpfed2_buteurs.id_match, phpfed2_joueurs.id
          FROM phpfed2_joueurs, phpfed2_equipes, phpfed2_buteurs, phpfed2_matchs, phpfed2_clubs, phpfed2_effectif
          WHERE phpfed2_equipes.id_club=phpfed2_clubs.id
          AND (
           phpfed2_matchs.id_equipe_dom = phpfed2_equipes.id
           OR phpfed2_matchs.id_equipe_ext = phpfed2_equipes.id
          ...
          AND phpfed2_joueurs.id_club=phpfed2_equipes.id_club
          AND phpfed2_buteurs.id_joueur=phpfed2_joueurs.id
          AND phpfed2_effectif.id_joueur=phpfed2_joueurs.id
          AND phpfed2_effectif.id_equipe=phpfed2_equipes.id";
...
while($row = mysql_fetch_array($resultat))
{
 mysql_query ("UPDATE phpfed2_buteurs SET id_effectif='$row[0]' WHERE id_match='$row[1]' and id_joueur='$row[2]'") or die ("probleme " .mysql_error());
}


$requete="SELECT DISTINCT phpfed2_joueurs.nom, phpfed2_joueurs.prenom, phpfed2_buteurs.id, phpfed2_journees.numero, phpfed2_matchs.date_reelle, phpfed2_joueurs.id
FROM phpfed2_joueurs, phpfed2_buteurs, phpfed2_matchs, phpfed2_equipes, phpfed2_journees
WHERE phpfed2_matchs.id = phpfed2_buteurs.id_match
AND phpfed2_buteurs.id_joueur = phpfed2_joueurs.id
AND phpfed2_buteurs.id_effectif =0
AND (
phpfed2_matchs.id_equipe_dom = phpfed2_equipes.id
OR phpfed2_matchs.id_equipe_ext = phpfed2_equipes.id
    )
...
{
echo "<form method=\"post\" action=../phpfed2//%22/%22>";
$i=0;
while($row = mysql_fetch_array($resultat))
{  
  echo SETUP_MAJ_INCOH." : $row[0] $row[1] ".SETUP_MAJ_INCOH_2." : ";
  $requete1="SELECT phpfed2_clubs.nom, phpfed2_equipes.id, phpfed2_matchs.id
             FROM phpfed2_joueurs, phpfed2_equipes, phpfed2_buteurs, phpfed2_matchs, phpfed2_clubs, phpfed2_journees
             WHERE phpfed2_equipes.id_club = phpfed2_clubs.id
             AND (
             phpfed2_matchs.id_equipe_dom = phpfed2_equipes.id
             OR phpfed2_matchs.id_equipe_ext = phpfed2_equipes.id
...
$sql_maj_1="ALTER TABLE `phpfed2_buteurs` CHANGE `id` `id` INT( 10 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_match` `id_match` INT( 10 ) UNSIGNED DEFAULT NULL ,
CHANGE `buts` `buts` TINYINT( 4 ) DEFAULT NULL;
ALTER TABLE `phpfed2_championnats` CHANGE `id` `id` TINYINT( 3 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
CHANGE `id_division` `id_division` TINYINT( 3 ) UNSIGNED DEFAULT '0' NOT NULL ,
...
$sql_maj_2="ALTER TABLE `phpfed2_clubs` DROP INDEX `id`;
ALTER TABLE `phpfed2_clubs` DROP INDEX `nom`;
ALTER TABLE `phpfed2_championnats` ADD PRIMARY KEY ( `id` );
ALTER TABLE `phpfed2_championnats` DROP INDEX `id`;
ALTER TABLE `phpfed2_championnats` DROP INDEX `id_saison`;
...
$requete="SELECT id_equipe, pts FROM phpfed2_tapis_vert";
$resultat=mysql_query($requete) or die (mysql_error());
...
while($row = mysql_fetch_array($resultat))
{
  ...
  $requete2="UPDATE phpfed2_equipes SET penalite = '$pts'  WHERE id = '$id_equipe'";
  $resultat2=mysql_query($requete2) or die (mysql_error());
}
...
CREATE TABLE `phpfed2_clmnt_cache` (
  `NOM` varchar(255) default NULL,
  `POINTS` smallint(4) unsigned default NULL,
  `JOUES` tinyint(3) unsigned default NULL,
  `G` tinyint(3) unsigned default NULL,
...
CREATE TABLE `phpfed2_divisions` (
  `id` int(4) unsigned NOT NULL auto_increment,
  `nom` varchar(255) NOT NULL default '',
  PRIMARY KEY  (`id`)
) ;
CREATE TABLE `phpfed2_donnee` (
  `id` smallint(5) unsigned NOT NULL auto_increment,
  `nom` text NOT NULL,
...
CREATE TABLE `phpfed2_gr_championnats` (
  `id` tinyint(3) unsigned NOT NULL auto_increment,
  `nom` varchar(255) NOT NULL default '',
...
CREATE TABLE `phpfed2_parametres` (
  `id_champ` int(4) unsigned NOT NULL default '0',
...
CREATE TABLE `phpfed2_pronostics` (
  `id_membre` smallint(5) unsigned NOT NULL default '0',
  `id_champ` int(3) unsigned NOT NULL default '0',
...
CREATE TABLE `phpfed2_saisons` (
  `id` int(4) unsigned NOT NULL auto_increment,
  `annee` year(4) NOT NULL default '0000',
  PRIMARY KEY  (`id`),
  KEY `id` (`id`)
) ;
INSERT INTO `phpfed2_membres` (`id_prono` , `pseudo` , `mot_de_passe` , `mail` , `nom_site` , `url_site`, `admin` )
                    VALUES ('$id_prono', '$pseudo', '$mdp', '$mail', '$nom_site', '$url_site','1')";
...
{ 
$to="phpfed2eague@univert.org<phpfed2eague@univert.org>";

$sujet="Nouvel utilisateur";

$message="<html><head>
<title>phpfed2eague</title>
</head>
<body>
<p align=\"center\"><u><font face=\"Verdana\" size=\"3\" color=\"#006A36\">Nouvel
utilisateur</font></u></p>
<p><font size=\"2\" face=\"Verdana\">Url : <a href=../phpfed2//%22$url_site/%22>$url_site</a></font></p>
