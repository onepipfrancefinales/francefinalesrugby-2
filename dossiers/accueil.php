  ...
  <tr>
    <td colspan="2" class="borderWidth1 ">
      ...
      <p class="size4">
        ...
        <a class="size5" style="text-decoration: none" href="/dossiers/actualites/pagesSuiviClub.php"> Suivez le vie du club de l'Isle en Dodon <br> <span class="size4">(Ligue Occitanie, régionale 1)</span> 

        </a>

      </p>
      <?php require 'video/serieVDR/J12.php'; ?>
      ...
      mais également de faire connaissance avec les joueurs, les coachs et toutes les personnes présentes autour de ce club.</div><br><br>

  <a class="size5" style="color: black; text-decoration: none" href="/dossiers/actualites/pagesSuiviClub.php">  Visionner toutes les journées </a>
  <br>
     <br>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td class="size5 background003366 colorWhite bold borderWidth1">
      <a class="colorWhite" href="https://francefinalesrugby.fr/smart/sommaire.php"
        style="text-decoration: none" target="_blank"> Accéder <br> à l'application </a>
    </td>
  </tr>
