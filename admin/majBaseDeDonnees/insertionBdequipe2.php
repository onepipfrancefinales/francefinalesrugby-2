 ...
 if (isset($ligueP))    ;    else   $ligueP = "inconnu";
		...
		if ($A1001>$A1002){	
		echo $id1 . ';' . $annee . ';' . $nomDivision. ';' . 'Champion'.';'.$clubA1001.';'.$clubA1001.';'.';'.'('.$ligue.')'.';'.$clubA1002.';'.'('.$ligue.")".';'.$A1001.';'.$A1002.';'.$nomLigue.';'.$div.';'.$constante.';'."B";
		echo "<br/>"; 
		echo $id2 . ';' . $annee . ';' . $nomDivision . ';' .'Vice champion' . ';' . $clubA1002 . ';' . $clubA1002 . ';' . ';' . ';' . ';' . '(' . $ligue . ")" . ';' . $A1002 . ';' . $A1001 . ';' . $nomLigue . ';' . $div . ';' . $constante . ';' . "B";
...
{
	echo $id1.';'.$annee.';'.$nomDivision.';'.'Champion'.';'.$clubA1002.';'.$clubA1002.';'.';'.'('.$ligue.')'.';'.$clubA1001.';'.'('.$ligue.")".';'.$A1002.';'.$A1001.';'.$nomLigue.';'.$div.';'.$constante.';'."B";
	echo "<br/>";
	echo $id2.';'.$annee.';'.$nomDivision.';'.$vice.';'.$clubA1001.';'.$clubA1001.';'.';'.';'.';'.'('.$ligue.")".';'.$A1001.';'.$A1002.';'.$nomLigue.';'.$div.';'.$constante.';'."B";
