<table width="100% " class="borderWidth1 marginAuto">
   ...
   <tr>
        <td colspan="2" class="borderWidth1 ">
            <br>
            <p class="size4">
                <a class="colorBlack" href="smartPage.php?page=serieVDR&mode=smart"><span class="bold styleArial size5">Suivez la série Youtube VDR</span> <br>
              <span class="size5 italic">   (Vie d'un Rugbyman)</span><br>
                </a>
            </p>
            <?php include '../dossiers/video/serieVDR/J9.php'; ?>
            <br>
            <div class="size4 styleArial" width="70%">
      ...
      mais également de faire connaissance avec les joueurs, les coachs et toutes les personnes présentes autour de ce club.</div>
        </td>
    </tr>
    <tr>
        <td colspan="2" class="borderWidth1 ">
    ...
    <tr>
       ...
       <tr>
        <td colspan="2" class="borderWidth1">
            <br>
            <p class="size4">
                <a class="colorBlack" href="smartPage.php?page=serieVDR&mode=smart">Série : Vie De Rugbymen</a><br><br>
